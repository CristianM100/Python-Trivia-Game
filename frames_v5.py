...
def frame_stats():
   ...
   # hbox.addWidget(button, alignment=QtCore.Qt.AlignmentFlag.AlignLeft)

    #top_row.setLayout(hbox)
    #grid.addWidget(top_row, 2, 0, 1, 2)
    ...
    for topic in topics:
        name = QLabel(topic)
        name.setStyleSheet("font-size: 15px; color: orange; margin-left: 50px")
