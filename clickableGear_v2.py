...
class ClickableWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Add persistent back button
        self.back_button = QPushButton("⬅️")  # use emoji for nicer look
        self.back_button.setCursor(QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.back_button.setFixedSize(50,40)
        ...
        self.back_button.setParent(self)  # make it appear on this widget
        self.back_button.move(10, 10)     # top-left corner
        self.back_button.show()
        self.back_button.clicked.connect(self.back_clicked.emit)  # just emit signal
    ...
    def paintEvent(self, event):
        ...
        painter.drawText(110, 80, "Questions in ")
        
        # Draw topic name in black
        painter.setPen(QPen(Qt.GlobalColor.black, 2))
        painter.drawText(380, 80, self.topic_name)
